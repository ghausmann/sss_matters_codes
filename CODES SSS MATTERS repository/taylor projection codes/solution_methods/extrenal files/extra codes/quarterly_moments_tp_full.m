function moments = quarterly_moments_tp_full(myt_sim_exp)
...
for ii=1:tn_quarters
    ...
    Y_quarterly_sum_aggregation(:,ii)=squeeze(sum(myt_sim_exp(2,(ii-1)*3+1:ii*3,:)));
    ...
    I_quarterly_sum_aggregation(:,ii)=squeeze(sum(myt_sim_exp(3,(ii-1)*3+1:ii*3,:)));

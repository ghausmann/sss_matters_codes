function y = euler_errors_fgru_uzawa(P2,nxss,nyss,derivs,x_1,eta,epsi_nodes,weight_nodes,approx)
%This function computes Euler equation errors of the SOE (Uzawa model)
...
rt = mgt(3); %log interest rate
ct = exp(mgt(1)); %consumption (normalized by DSS)

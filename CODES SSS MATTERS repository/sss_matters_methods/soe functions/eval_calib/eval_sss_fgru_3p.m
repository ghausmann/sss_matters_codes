...
% the paper, using the auxiliary model of Section 2.2 in the paper.

function y = eval_sss_fgru_3p(x,model,params,my_dss_params,M,eta,eps_ind,approx)
...
[nxss,nyss,psi_k,C_bar] = my_dss_aux(x,my_dss_params);
